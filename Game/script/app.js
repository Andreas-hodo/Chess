...
class Square extends Board{
  ...
  #handleClick(e){ 
    ...
    let sqelem = document.getElementById(this.getName())
    pieceobj.drop({drag:pieceelem,drop:sqelem})
  }
  Click(){
    let sqelem = document.getElementById(this.getName())
    sqelem.addEventListener("click",this.#handleClick.bind(this))
  }
  decode(){
    let x = this.getx()
    let y = this.gety()
...
class Piece extends Board{
  ...
  Click(){
    this.#pieceElement.addEventListener("click",this.#handleClick.bind(this))
  }
  #handleClick(e){
