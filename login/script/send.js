...
function username(){
  ...
  localStorage.setItem("disname",true)
...
function message(loggeduser,form,type,email,error = false,Errormessage = ""){
...
function checkEmailVerified(userlogged){
  ...
  auth.onAuthStateChanged(user =>{
    if(user){
      ...
      localStorage.setItem("disname",false)
      if(emailVerified){
...
function validation(){
  ...
  if(localStorage.getItem("emailSent") && localStorage.getItem("emailVerified") == "false"){
    ...
    checkEmailVerified()
  }else if(localStorage.getItem("emailVerified") && localStorage.getItem("disname") == "false"){
    username()
  }    
}
