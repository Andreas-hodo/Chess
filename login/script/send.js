   ...
   return loggeduser
    ...
    if (!loggeduser.emailVerified) { 
        ...
        await loggeduser.user.sendEmailVerification({
          continueUrl:"https://andreas-hodo.github.io/Chess/game"
        })
          //url: 'https://andreas-hodo.github.io/Chess/email-verification'
          //https://andreas-hodo.github.io/Chess/login/email-verification/); 
