...
cookiepopup.innerHTML = `<div id="imagecontainer">
    ...
    <div id="detailscontainer">
        ...
        <p class="detailscookie">This website uses cookies to</p>
        <p class="detailscookie">ensure you get the best</p><p class="detailscookie">experience on our website.</p>
  ...
  let openedusername = localStorage.getItem("emailVerified") && localStorage.getItem("disname") == "false"
  let namepopup = document.querySelector(".usernamepanel")
  if(openedusername){  
