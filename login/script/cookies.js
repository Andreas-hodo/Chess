...
cookiepopup.innerHTML = `<div id="imagecontainer">
  ...
  if(localStorage.getItem("cookiesaccected") == "true"){
    cookiepopup.style.display = "none"
      if(localStorage.getItem("cookiesaccected") == "true" && localStorage.getItem("name") && localStorage.getItem("pass")){
        var username_elem = document.getElementById("username_login")
        var password_elem = document.getElementById("password_login")
        username_elem.value = localStorage.getItem("name")
        password_elem.value = localStorage.getItem("pass")
  }
  }else{
