            ...
            let digits;
              for(let i = 0; i < numsArr.length; i++){
                if(parseInt(numsArr[i]) > 0){
                  let num = parseInt(numsArr.slice(i,numsArr.length).join("")) + 1
          ...
          let actions = {
            ...
            details: async (type,user)=>{
              ...
              return await readMyUserDetails().then(allusers =>{
                ...
                details = {roomId:newUsersNum,displayName:user.displayName}
              }
               return details
              })                                
            }
            ...
            try {
              actions.details(typedet,user).then(Alldetails =>{
